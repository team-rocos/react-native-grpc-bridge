...
# Copy the code
WORKDIR /go/src/github.com/team-rocos/react-native-grpc-bridge/server/echoserver/echo
COPY ./proto ./proto
...
WORKDIR /go/src/github.com/team-rocos/react-native-grpc-bridge/server/echoserver/echo/echoserver
